    ...
    <div className="min-h-screen bg-gradient-to-t from-gray-50 to-gray-200 flex flex-col items-center justify-center relative overflow-hidden ">
      <main className="container   flex-grow p-12 flex flex-col items-center z-10 sm:p-1 sm:py-8">
        <section className="text-center mb-8 ">
          <h2 className="text-4xl font-extrabold	text-white mb-4 animate-fadeInDown text-zinc-700 sm:text-lg">İş Takip Sistemi Nedir?</h2>
          <p className="text-white font-extrabold text-xl max-w-2xl mx-auto animate-fadeInUp text-zinc-500 sm:text-xs ">
        ...
        <section className="text-center mb-8">
          <h2 className="text-4xl font-extrabold	 text-white mb-4 animate-fadeInDown text-zinc-700 sm:text-lg">Özellikler</h2>
          <ul className="text-white font-extrabold text-xl  list-inside animate-fadeInUp text-zinc-500 sm:text-xs">
        ...
        <section className="text-center mb-8">
          <h2 className="text-4xl font-extrabold	 text-white mb-4 animate-fadeInDown text-zinc-700 sm:text-lg">Kullanım Alanları</h2>
          <div className="text-white font-extrabold text-xl max-w-2xl mx-auto animate-fadeInUp space-y-4 text-zinc-500 sm:text-xs">
